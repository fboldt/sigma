...
def example_rgb():
    ...
    output_dir = './images' 
    output_filename = 'TRUE_COLOR2.tif'

    output_file_path = os.path.join(output_dir, output_filename)

    # Caminhos completos para as bandas vermelha, verde e azul
    red_band_path = os.path.join(input_path, 'CBERS_4A_WPM_20250609_195_138_L4_BAND3.tif')
    green_band_path = os.path.join(input_path, 'CBERS_4A_WPM_20250609_195_138_L4_BAND2.tif')
    blue_band_path = os.path.join(input_path, 'CBERS_4A_WPM_20250609_195_138_L4_BAND1.tif')
