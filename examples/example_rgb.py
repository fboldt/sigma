...
def example_rgb():
    ...
    input_path = './images/CBERS4A_WPM19613920250604ETC2' 
    ...
    red_band_path = os.path.join(input_path, 'CBERS_4A_WPM_20250604_196_139_L4_BAND3.tif')
    green_band_path = os.path.join(input_path, 'CBERS_4A_WPM_20250604_196_139_L4_BAND2.tif')
